...
class AuthManager:
        ...
        try:
            ...
            async with async_playwright() as pw:
                ...
                try:
                    ...
                    await self._save_cookies(context, user_id)
    ...
    async def _save_cookies(self, context: Any, user_id: int) -> None:
        """Экспортирует cookies браузера через коннектор хранилища."""
