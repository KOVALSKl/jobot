...
TEXTS: dict[str, str] = {
    ...
    "apply.exclude_mode_prompt": (
        "🎯 Выберите режим фильтрации исключений.\n\n"
        "🛡 <b>Safe (по умолчанию)</b> — более аккуратная фильтрация по границам слов/фраз.\n"
        "⚡ <b>Partial</b> — агрессивная фильтрация по минимальному подстрочному совпадению.\n\n"
        "Для коротких терминов (например, <code>c</code>) partial-режим может пропустить слишком много вакансий."
    ),
    "apply.partial_short_terms_warning": (
        "⚠️ Вы выбрали <b>Partial</b> и указали короткие исключения ({terms}).\n"
        "Это рискованный режим: короткие термины часто дают массовые ложные исключения.\n\n"
        "Подтвердите, что хотите продолжить."
    ),
    "apply.mode_label_default_safe": "🛡 safe",
    "apply.mode_label_partial_aggressive": "⚡ partial",
    ...
    "start.help": (
        ...
        "/cancel_task — Отменить фоновую задачу\n"
